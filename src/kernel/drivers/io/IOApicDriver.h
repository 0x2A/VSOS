...
public:
	...
	virtual const std::string GetCompatHID() override;
	virtual Driver* CreateInstance(Device* device) override;

	virtual Result Initialize() override;
	virtual Result Read(char* buffer, size_t length, size_t* bytesRead = nullptr) override;
	virtual Result Write(const char* buffer, size_t length) override;
	virtual Result EnumerateChildren() override;
